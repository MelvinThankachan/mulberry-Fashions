...
urlpatterns = [
    ...
    path('add-to-favourite/<product_id>/', views.add_to_favourite, name="add_to_favourite"),
    path('update-cart-item/<cart_item_id>/', views.update_cart_item, name="update_cart_item"),
    path('remove-cart-item/<cart_item_id>/', views.remove_cart_item, name="remove_cart_item"),
    path('remove-favourite-item/<favourite_item_id>/', views.remove_favourite_item, name="remove_favourite_item"),
